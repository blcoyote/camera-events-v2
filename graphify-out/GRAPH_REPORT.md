...
Cohesion: 0.08
Nodes (23): FrigateCameraConfig, FrigateCameraStats, FrigateConfig, FrigateCpuUsage, FrigateDetectorStats, FrigateEventData, FrigateEventSummary, FrigateEventSummaryItem (+15 more)
...
Cohesion: 0.21
Nodes (9): dispatchBatch(), eventBatcher, MqttConnectionState, onFrigateMessage(), parseFrigateEvent(), startMqttSubscriber(), SUBSCRIBED_TOPICS, { windowMs, burstGapMs } (+1 more)
...
### Community 26 - "randomInt"
Cohesion: 0.23
Nodes (17): generateEvent(), generateReview(), generateTimelineEntry(), getEvent(), getEvents(), getEventSummary(), getReviews(), getReviewSummary() (+9 more)

### Community 27 - "event-batcher.ts"
Cohesion: 0.20
Nodes (5): originals, TUNABLES, FlushCallback, FlushMeta, FrigateEventInfo

### Community 28 - "push-notify.ts"
Cohesion: 0.25
Nodes (12): appleUpdateThrottle, buildCameraPayload(), cameraNotificationTag(), endpointHost(), formatCameraName(), formatLabel(), formatTime(), notifyUsersForCamera() (+4 more)
