...
Tests that document what the code _actually does_, not what it _should do_. They lock down existing behavior so you can detect unintended changes. Characterization tests answer: "If I make a change here, what breaks?"
