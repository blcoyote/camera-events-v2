...
/**
 * Pure function: build display content for an event detail page.
 * Returns a not-found shape when the event is undefined.
 */
...
export const Route = createFileRoute('/_authenticated/camera-events/$id')({
  component: CameraEventDetailComponent,
})

function CameraEventDetailComponent() {
      ...
      <section className="island-shell rise-in relative overflow-hidden rounded-[2rem] px-6 py-10 sm:px-10 sm:py-14">
        ...
        <dl className="mt-6 grid gap-4 sm:grid-cols-2">
          <div className="rounded-xl border border-[var(--line)] bg-[var(--surface)] p-4">
            ...
            <dd className="mt-1 text-base font-medium text-[var(--sea-ink)]">
              {content.camera}
            </dd>
          </div>
          <div className="rounded-xl border border-[var(--line)] bg-[var(--surface)] p-4">
